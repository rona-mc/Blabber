...
package net.sjhub.blabber.network;
...
/**
 * A type of packet. An instance of this should be created per a {@link ForgePacket} implementation.
 * This holds the channel ID used for the packet.
 *
 * @param <T> the type of the packet
 * @see ForgePacket
 */
public final class PacketType<T extends ForgePacket> {
	 ...
	 */
	public static <P extends ForgePacket> PacketType<P> create(ResourceLocation id, Function<FriendlyByteBuf, P> constructor) {
		return new PacketType<>(id, constructor);
	}

	/**
	 * Returns the ResourceLocation of the channel used to send the packet.
	 * @return the ResourceLocation of the associated channel.
	 */
