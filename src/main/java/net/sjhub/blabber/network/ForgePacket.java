 ...
 *
 * 	public BoomPacket(FriendlyByteBuf buf) {
 ...
 * @see ServerPlayNetworking#send(ServerPlayer, PacketType, ForgePacket)
 * @see PacketSender#sendPacket(PacketType, ForgePacket)
 */
